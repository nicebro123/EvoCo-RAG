...
class TrainingConfig:
    ...
    # Large-model optimization method. ``grpo`` follows the CoRAG-style
    # reward anchor: generated completions are rewarded by deterministic
    # gold-alias substring/EM matching, without LLM-as-judge.
    large_train_method: str = "sft"  # sft | grpo
